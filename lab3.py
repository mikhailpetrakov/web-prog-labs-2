...
def rzd():
    ...
    return render_template('lab3/rzd.html', user=user, age=age, place=place, exit=exit, arrival=arrival, date=date, errors=errors)
...
# Список продуктов
products = [
    {"name": "Смартфон A", "price": 550, "brand": "Brand A", "color": "Черный"},
    {"name": "Смартфон B", "price": 750, "brand": "Brand B", "color": "Синий"},
    {"name": "Смартфон C", "price": 350, "brand": "Brand C", "color": "Белый"},
    {"name": "Смартфон D", "price": 950, "brand": "Brand A", "color": "Красный"},
    {"name": "Смартфон E", "price": 450, "brand": "Brand B", "color": "Серый"},
    {"name": "Смартфон F", "price": 650, "brand": "Brand C", "color": "Золотой"},
    {"name": "Смартфон G", "price": 850, "brand": "Brand A", "color": "Зеленый"},
    {"name": "Смартфон H", "price": 250, "brand": "Brand B", "color": "Фиолетовый"},
    {"name": "Смартфон I", "price": 1050, "brand": "Brand C", "color": "Розовый"},
    {"name": "Смартфон J", "price": 500, "brand": "Brand A", "color": "Оранжевый"},
    {"name": "Смартфон K", "price": 700, "brand": "Brand B", "color": "Коричневый"},
    {"name": "Смартфон L", "price": 300, "brand": "Brand C", "color": "Бирюзовый"},
    {"name": "Смартфон M", "price": 900, "brand": "Brand A", "color": "Желтый"},
    {"name": "Смартфон N", "price": 400, "brand": "Brand B", "color": "Серебряный"},
    {"name": "Смартфон O", "price": 600, "brand": "Brand C", "color": "Бронзовый"},
    {"name": "Смартфон P", "price": 800, "brand": "Brand A", "color": "Черный"},
    {"name": "Смартфон Q", "price": 200, "brand": "Brand B", "color": "Синий"},
    {"name": "Смартфон R", "price": 1000, "brand": "Brand C", "color": "Белый"},
